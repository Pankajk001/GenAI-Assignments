...
def chat(message):
    mem_result = mem_client.search(query=message, user_id="pk123") #it will create the vector embeddings of message and search and then find their relations and nodes

    print(f"mem_result {mem_result}")
